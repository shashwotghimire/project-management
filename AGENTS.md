...
**GIT Rules**: when asked to push changes to main, Codex will do git add ., write suitable commit message & push to main. STRICTLY PROHIBITED: using <Codex@anthropic.com> to co-author commits. ONLY co-author with <noreply@anthropic.com>
